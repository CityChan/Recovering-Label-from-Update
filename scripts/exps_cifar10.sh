...
# iRLG
python main.py --scheme iRLG --local_epoch 1 --dataset CIFAR10 --momentum 0.0 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512

# RLU
python main.py --scheme RLU --local_epoch 1 --dataset CIFAR10 --momentum 0.0 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512

# LLGp
python main.py --scheme LLGp --local_epoch 1 --dataset CIFAR10 --momentum 0.0 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512

# ZLGp
python main.py --scheme ZLGp --local_epoch 1 --dataset CIFAR10 --momentum 0.0 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512
...
# RLU
python main.py --scheme RLU --local_epoch 10 --dataset CIFAR10 --momentum 0.9 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512 --lr 0.05

# LLGp
python main.py --scheme LLGp --local_epoch 10 --dataset CIFAR10 --momentum 0.9 --alpha 0.5 --batch_size 64 --model vgg16 --hidden 512 --lr 0.05
