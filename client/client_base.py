    ...
    def RLU(self, global_weights):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            if count == self.args.local_epochs:
                ...
                n = estimated_entropy_from_grad(self.args, new_shift * new_shift * rho_mean,
                                                b_grad_epochs.detach().cpu().tolist(),
                ...
                n = estimated_entropy_from_grad(self.args, new_shift_softmax * rho_mean,
                                                b_grad_epochs.detach().cpu().tolist(),
                                                self.args.batch_size * self.args.local_epochs)
